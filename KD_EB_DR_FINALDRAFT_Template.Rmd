---
title: "An Analysis of the Drivers of Harmful Algal Blooms in Lake Erie"
author: "Kallie Davis, Dori Rathmell, and Emma Brentjens"
output:
...
\newpage
To explore the third question, a summary statistics table (Table 3) was generated to show the number of observations, mean, standard deviation, median, maximum and minimum values within each group of interest (i.e., surface and bottom depth categories). This was conducted to evaluate balance within the data regarding the number of observations but also to get a glimpse into trends for both bottom and surface depth observations
...
```{r, include=FALSE}
#Wilcoxon Rank Sum test table formatting
...
***Table 7. Wilcoxon Rank Sum Test for bottom versus surface depths.***
```{r, warning = FALSE, meassage = FALSE, echo = FALSE}
gt(wilcox_reorder) %>% 
  tab_header(
