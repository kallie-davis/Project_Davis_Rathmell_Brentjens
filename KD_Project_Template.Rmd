...
#bottom_surface_Erie_dropNA_DO$CTD.Dissolved.Oxygen.mg.L <- factor(bottom_surface_Erie_dropNA_DO$CTD.Dissolved.Oxygen.mg.L, levels = c("Surface", "Bottom"))
```
...
#There is no bottom level data for DO, so we will have to exclude this part

#wilcox.test(CTD.Dissolved.Oxygen.mg.L ~ Sample.Depth.category, data = bottom_surface_Erie_dropNA_DO, alternative = "greater") #Due to nonnormality of the data, a rank sum test was applied
```
