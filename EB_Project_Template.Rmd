...
linear_model_results$Term[linear_model_results$Term == "(Intercept)"] <- "Intercept"
...
gt() %>%
  ...
  sub_values(p_value = c(74, 500), replacement = 150)
...
\newpage
We further used linear modeling to assess the relationships between chlorophyll a and microcystin and water temperature in 2022.  
